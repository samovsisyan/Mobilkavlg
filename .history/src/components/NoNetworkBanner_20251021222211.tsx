...
//   if (isOnline) return null;
  ...
  return (
    <div className="fixed bottom-2 left-[20%] right-10 bg-white text-white p-4 text-center z-50 border border-[#Выключите VPN
VPN замедляет работу  сайта, из-за чего могут возникать непредвиденные ошибки.] rounded-lg">
