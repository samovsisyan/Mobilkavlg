    ...
    <div className="fixed inset-0 z-[100]">
      ...
      <div className="absolute inset-0 grid place-items-center p-4">
        <div
          ...
          aria-modal="true"
          className={
            `relative w-full max-w-[95vw] sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl 2xl:max-w-2xl rounded-2xl bg-white shadow-[0_20px_60px_rgba(0,0,0,0.2)] border border-slate-200 ${className || ''}`
          }
        >
          <button
