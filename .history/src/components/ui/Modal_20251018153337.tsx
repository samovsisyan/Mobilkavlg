...
export default function Modal({ open, onClose, title, children, className = 'max-w-2xl' }: ModalProps) {
  React.useEffect(() => {
    ...
    <div className="fixed inset-0 z-[100]">
      ...
      <div className="absolute inset-0 grid place-items-center p-4">
        <div
          ...
          aria-modal="true"
          className={
            `relative w-full max-w-[95vw] rounded-2xl bg-white shadow-[0_20px_60px_rgba(0,0,0,0.2)] border border-slate-200 ${className ? className : '"max-w-2xl'}`
          }
        >
          <button
