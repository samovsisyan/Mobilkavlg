            ...
            <div className="p-6 sm:p-8">
              ...
              <div className="mt-10 bg-blue-50 p-6 rounded-lg">
                <div className="flex flex-col sm:flex-row items-center justify-between">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">Стоимость от {service.price}</h3>
                    <p className="mt-1 text-sm text-gray-600">Точная стоимость определяется после диагностики</p>
                  </div>
                  <button
                    onClick={() => openCallRequestModal(service.title)}
                    className="mt-4 sm:mt-0 w-full sm:w-auto px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors"
                  >
