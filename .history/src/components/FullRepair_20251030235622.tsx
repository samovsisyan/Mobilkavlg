        ...
        <div className="mt-8 sm:mt-10 grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
          {data.map((card) => (
            <article
              ...
              className="rounded-xl border border-slate-200 bg-white p-5 sm:p-6 shadow-[0_8px_24px_rgba(0,0,0,0.06)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.1)] transition-shadow cursor-pointer">
