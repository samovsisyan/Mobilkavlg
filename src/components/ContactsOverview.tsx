        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6">
          ...
          <Card className=" bg-colors-blueActive">
            ...
            <div className="mt-5 space-y-3">
              <Button href="/contacts" variant="primary" className="w-full">
                Заказать звонок
              </Button>
              <Button href="/contacts" variant="ghost" className="w-full border-blue-700 text-blue-700 hover:bg-blue-50">
                Связаться с нами
              </Button>
            </div>
