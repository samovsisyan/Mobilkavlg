...
export default function Button(props: ButtonProps) {
  ...
  if ("href" in props && props.href) {
    ...
    const linkProps = {
      href,
      prefetch: prefetch ? undefined : false, // Convert to undefined if true to avoid passing boolean to DOM
      className: classes,
      ...anchorProps
    };
    
    // Create a wrapper div to ensure consistent rendering between server and client
    return (
