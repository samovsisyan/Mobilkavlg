    ...
    <div className="fixed bottom-2 left-[20%] right-10 bg-white text-white p-8 text-center z-50 border border-[#9CA3AF] rounded-lg">
      <div className="container mx-auto flex flex-row gap-4 items-end">
        ...
        <div className='flex flex-col gap-2 items-start text-black '>
            ...
            <p className='text-sm text-start'>Продолжая работу с сайтом, Вы разрешаете использование cookie-файлов <a href="">(подробнее об политике конфиденциальности читайте тут)</a></p>
        </div>
        <Button 
