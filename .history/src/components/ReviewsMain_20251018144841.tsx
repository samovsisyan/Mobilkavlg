  ...
  return (
    <section className="relative isolate overflow-hidden bg-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20 md:py-24 text-center">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold leading-tight max-w-[900px] mx-auto">
          <span className="text-white">Отзывы тех, кто уже <span className="text-blue-400">доверил нам </span> свою технику</span>          
        </h1>
