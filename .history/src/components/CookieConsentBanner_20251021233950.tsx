    ...
    <div className="fixed bottom-2 left-[2%] md:left-[20%]  md:right-10 right-2 bg-white text-white p-2 md:p-8 text-center z-50 border border-[#9CA3AF] rounded-lg">
      <div className=" flex flex-row gap-4 items-start">
        ...
        <div className='flex flex-col gap-2 items-start text-black '>
            <p className='font-bold text-start font-medium'>Мы используем файлы cookie</p> 
            <p className='text-sm text-start fon'>Продолжая работу с сайтом, Вы разрешаете использование cookie-файлов <Link href="/" className='underline'>(подробнее об политике конфиденциальности читайте тут)</Link></p>
        </div>
        {isLg && <Button 
