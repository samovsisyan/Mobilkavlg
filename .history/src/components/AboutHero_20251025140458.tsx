...
import bg from "@/assets/mainIllustration/aboutUsMainIllustration.png";
    ...
    <section className="relative isolate overflow-hidden bg-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20 md:py-24 text-center">
        <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold leading-tight">
          <span className="text-blue-400">Мы — самый надежный <span className="text-white">сервис</span></span>
          <br />
          <span className="text-white">по ремонту в Волгограде</span>
        </h1>
