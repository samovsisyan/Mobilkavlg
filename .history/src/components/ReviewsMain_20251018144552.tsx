  ...
  return (
    <section className="relative isolate overflow-hidden bg-slate-900">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20 md:py-24 text-center">
        ...
        {/* Stats */}
        <div style={{ width: '70%', display: 'flex', justifyContent: 'center', alignItems: 'baseline', margin: '0 auto' }}>
          <div className="<div className="flex flex-wrap flex-wrap justify-center w-full mx-auto gap-8 pt-9">">
          {[{
            icon: AvitoOnlyLogo,
            kpi: "5+",
